...
canvas_width = 400
canvas_height = 525
green_img = manual_crop_image("pad_green.png", (canvas_width, canvas_height))
yellow_img = manual_crop_image("pad_yellow.png", (canvas_width, canvas_height))
red_img = manual_crop_image("pad_red.png", (canvas_width, canvas_height))
...
canvas.pack()
canvas_image = canvas.create_image(0, 0, anchor="nw", image=green_img)
...
def live_monitor():
    ...
    while not stop_live:
        ...
        if resistance_value < 130:
            ...
            canvas.itemconfig(canvas_image, image=yellow_img)
        else:
            canvas.itemconfig(canvas_image, image=red_img if flash else "")
            flash = not flash
